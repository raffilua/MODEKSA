...
send(msg.chat_id_, msg.id_,'اصدار سورس بومبر الاول 1') 
end
...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس بومبر' or text == 'اريد بوت تمبلر' or text == 'سورس بومبر' then
Text = [[
•- DEV @xixxx 
]]
send(msg.chat_id_, msg.id_,Text)
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس بومبر
...
if text == '@xixxx' or text == '@NiGGa_SoUrcE' or text == 'مودي البدراني' then
Text = [[
@xixxx هذا مطور سورس بومبر
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بومبر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بومبر')
local MODEDEV_Msg = {
'ۿۧهلا ؏ـمࢪي .',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بومبر').." غادر" or text == 'بوت غادر' then  
